...
def main(dataset_name:str,run_count:int=None,seed:int=42):
    ...
    HATR = preprocessing.MinMaxScaler() | tree.HoeffdingAdaptiveTreeRegressor(seed=seed)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Hoeffding Adaptive Tree Regression Script")
